<template>
  <div class="chat-module">
    <div class="chat-app-layout">
      <!-- 顶部栏 -->
      <div class="app-header" :class="{ 'moments-header-style': currentTab === 'moments' }" id="chatAppHeader" v-if="showHeader">
        ...
        <div class="title" id="chatAppTitle" v-if="!isChatRoom && currentTab !== 'moments'">WeChat</div>
        ...
        <div class="right-controls" style="display: flex; align-items: center;">
          <div class="action-btn" id="chatAppActionBtn" @click="openAddModal" v-if="!isChatRoom && currentTab !== 'moments'">
      ...
      <!-- 底部导航栏 -->
      <div class="chat-bottom-nav" v-if="!isChatRoom && currentTab !== 'moments'">
