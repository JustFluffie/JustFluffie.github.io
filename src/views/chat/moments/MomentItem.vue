      ...
      <div class="moment-footer">
        ...
        <div class="actions">
          ...
          <div v-if="isMenuOpen" class="action-menu">
            <div class="menu-item" @click.stop="handleFavorite">
...
const isFavorited = computed(() => singleStore.isMomentFavorited(props.moment.id));
...
const handleFavorite = () => {
  if (isFavorited.value) {
    singleStore.removeMomentFromFavorites(props.moment.id);
  } else {
    singleStore.addMomentToFavorites(props.moment);
  }
  emit('toggle-menu', null); // Close menu after action
};
