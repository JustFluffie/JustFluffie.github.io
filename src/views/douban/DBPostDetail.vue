<template>
  <AppLayout :title="post ? '帖子详情' : '加载中...'" no-padding>
          ...
          <div v-for="comment in post.commentsList" :key="comment.id" class="comment-item">
            <div class="comment-meta">
              <div class="comment-avatar">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="12" cy="8" r="4" :fill="comment.avatarColor"></circle>
                  <path d="M12 14C8.68629 14 6 16.6863 6 20H18C18 16.6863 15.3137 14 12 14Z" :fill="comment.avatarColor"></path>
                </svg>
              </div>
...
<style scoped>
.post-detail-page { background-color: #fff; }
...
.avatar { width: 40px; height: 40px; border-radius: 50%; margin-right: 12px; display: inline-flex; align-items: center; justify-content: center; }
