import{ch as b,r as I,W as v,u as y}from"./index-LMiDZmIY.js";const M={校园热线:"关于课程、考试、社团、老师同学的校园生活趣事。",职场茶水间:"关于办公室日常、吐槽老板同事、加班摸鱼的职场八卦。",自由吃瓜基地:"关于明星、网红、热门事件的最新娱乐八卦。",情感树洞:"关于恋爱烦恼、失恋心情、暗恋故事的个人情感困扰。",深夜食堂:"关于深入、坦诚地探讨两性关系、性幻想、个人欲望、情感禁区，以及其他在日常生活中不便公开的成熟话题。"};function w(o,s,t,r){const m=M[o]||"通用生活",d=t?`
