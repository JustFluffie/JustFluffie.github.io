import{ci as C,r as $,Z as v,k as F}from"./index-BFhJBr4-.js";const w={"同学，我有一个朋友...":"各年龄段学生们的专属讨论区。核心内容是围绕校园生活展开的各类**趣闻、吐槽和非公开信息（八卦）**。讨论范围包括但不限于：课程/考试攻略与吐槽、社团内部消息、师生关系、同学间的爱恨情仇等。学生在这里分享和打探校园内的第一手信息。","我今天就要离职！(明天再说)":"为已步入社会的人们打造的讨论区。核心是分享和吐槽**工作与社会**中的人和事，是“社畜”们的情绪宣泄出口。讨论范围包括：奇葩老板/同事、办公室恋情、行业内幕、摸鱼技巧、离职念头与经验分享等。",野生瓜田种植与品鉴:"专注于**公众人物（明星、网红、豪门等）**八卦的集中讨论区。它适合那些热衷于追踪娱乐动态、进行**深度分析或角色扮演（如模拟圈内人）**的人群。内容覆盖：艺人星途预测（“飞升”或“塌房”）、作品与人品评析（“拉踩”）、绯闻事件追踪、以及各种未经证实的圈内秘闻（“瓜”）。",恋爱细节放大镜小组:"聚焦于**个人情感，特别是恋爱关系中细腻、模糊、拉扯阶段**的讨论区。它适合所有正在经历或回味**暗恋、暧昧、情感博弈**的人群。核心讨论方式是**对恋爱中的细节进行过度分析和解读**，例如：分析聊天记录、解读对方行为信号、分享“上头”与“下头”的瞬间、探讨如何推进或结束一段关系等。这是一个用理性剖析感性的地方。",深夜食堂:"NSFW（Not Safe For Work）讨论区，以“性”为核心，内容用词直白下流、放纵露骨。这里只有欲望，没有伦理道德的束缚，没有年龄的限制，无论多肮脏下流都允许。对多元的性观念和实践（如不同的性偏好、性癖）保持开放和包容的态度，专注于事实描述和无偏见的交流"};function O(e,i,a,l){const d=w[e]||"通用生活",f=a?`
